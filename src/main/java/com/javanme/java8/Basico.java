...
public class Basico {
    ...
    public List<String> ejercicio1(List<String> palabras) {
        return palabras.stream().map(String::toUpperCase).collect(Collectors.toCollection(ArrayList::new));
    }
    ...
    public List<String> ejercicio2(List<String> listado) {
        return listado.stream().filter(p -> p.length() > 10).collect(Collectors.toCollection(ArrayList::new));
    }
    ...
    public String ejercicio3(List<String> listado) {
        return listado.stream().limit(5).skip(2).collect(Collectors.joining("-"));
    }
    ...
    public List<String> ejercicio5(List<String> listado) {
        ...
        return listado.stream().sorted(Comparator.naturalOrder()).sorted(comparator).collect(Collectors.toList());
    }
}